...
<form>
	...
	<div class="mymy">
		<img src="${pageContext.request.contextPath}/dist/img/logo.png" alt="프로필 사진을 로딩 중 입니다.">
	</div>
	<div class="mymy">
		<table class="table">
			<tr>
			...
			<tr>
			<td><a href="/user/changePwdForm">[암호변경]</a></td><td class="please"><a href="/user/logout">[로그아웃]</a></td>
			</tr>
		</table>
			<br />
	</div>
