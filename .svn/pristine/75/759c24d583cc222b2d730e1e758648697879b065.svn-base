...
public class StoreVO {
	...
	public String toString() {
		return "StoreVO [storeid=" + storeid + ", img=" + img + ", storename=" + storename + ", location=" + location
				...
				+ delivery + ", tastestar=" + tastestar + ", costefstar=" + costefstar + ", servicestar=" + servicestar
				+ "]";
	}
